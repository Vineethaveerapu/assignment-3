...
let conservation = new MainContent(
  "conservation",
  "Focus on Conservation",
  "By the mid-2000s, Nature's Zoo had established itself as a leader in conservation. The zoo launched multiple projects, aimed at reintroducing endangered species to the wild. Partnerships with wildlife organizations and local schools helped build a strong community support system, spreading awareness about conservation."
);
let innovation = new MainContent(
  "innovations",
  "Innovation and Visitor's Experience",
  "In recent Years, Nature's Zoo has embraced technology and innovation, introducing features like interactive exhibits virtual reality tours, and educational workshops. The zoo is now home to over 25 species, with a special emphasis on animal welfare, conservation research, and sustainable practices."
);
let goal = new MainContent(
  "goal",
  "Present and Future",
  "Today, Nature's Zoo continues to be a hub for conservation, research, and education. With future plans to expand exhibits and develop more breeding programs, the zoo remains dedicated to its mission of connecting people with nature and inspiring a global movement for wildlife conservation."
);
let history = new MainContent(
  "history",
  "About Us",
...
let aquarium = new Facilities(
  "aquarium",
  "./images/aquarium1.jpg",
  "./images/aquarium1.jpg",
  "Aquarium",
  "Explore the wonders of the deep at Nature's Zoo's stunning Aquarium, home to colorful coral reefs, majestic sharks, playful sea otters, and vibrant schools of tropical fish. Interactive touch pools let visitors get up close with starfish and other marine creatures, offering an engaging and educational underwater experience for all ages."
);
let rides = new Facilities(
  "rides",
  "./images/rides.jpg",
  "./images/rides.jpg",
  "Rides",
  "For thrill-seekers, our exciting Jungle Safari Ride takes you on a guided tour through lush habitats. For an experience, enjoy the Tree-Top Sky Ride, offering a gentle, bird's-eye view of the zoo's beautiful landscapes. The Zoo Train, a favorite with families, provides a leisurely ride around the zoo."
);
...
facilitiesArray.forEach((grid) =>
  grid.addEventListener("mouseenter", () => grid.classList.add("highlight"))
);
facilitiesArray.forEach((grid) =>
  grid.addEventListener("mouseleave", () => grid.classList.remove("highlight"))
);
...
function TicketDetails(className, icon, iconAlt, detail) {
  ...
  this.description = () => {
    ...
    ticketContent.textContent = this.detail;
    ticketClass.appendChild(ticketContent);
  };
}

let time = new TicketDetails("details", "", "", "opening hours");
let hours = new TicketDetails(
  "time",
  "./images/clock.svg",
  "Clock-icon",
  "09.00 - 18.00 All days"
);
let address = new TicketDetails("details", "", "", "Address");
let addressDetails = new TicketDetails(
  "address",
  "./images/location.svg",
  "Map-icon",
  "Roskildevej 32, 2000 Frederiksberg."
);
let disabledOption = new TicketDetails(
  "details",
  "",
  "",
  "disablity conditions"
);
let disabledDetails = new TicketDetails(
  "disabled",
...
let lionFeed = new TicketDetails(
  "lion",
  "./images/lion.svg",
  "Lion-icon",
  "12.00 - 12.30"
...
let bearFeed = new TicketDetails(
  "bear",
  "./images/bear.svg",
  "Bear-icon",
  "13.00 - 13.30"
...
let dolphinShow = new TicketDetails(
  "dolphin",
  "./images/dolphin.svg",
  "Dolphin-icon",
  "14.00 - 14.45"
